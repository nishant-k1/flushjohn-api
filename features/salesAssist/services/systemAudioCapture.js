...
export const validateConfiguration = () => {
  ...
  if (!device || device.trim() === "") {
    console.warn(
      "[SystemAudio] WARNING: SYSTEM_AUDIO_DEVICE not configured. System audio capture may not work."
    );
    console.warn(
      "[SystemAudio] Set SYSTEM_AUDIO_DEVICE environment variable to the name of your virtual audio device (e.g., 'BlackHole 16ch')"
    );
    return false;
  }
