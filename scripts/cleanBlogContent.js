...
import Blogs from '../features/blogs/models/Blogs/index.js';

async function cleanBlogContent() {
  console.log('🧹 Cleaning blog content - removing HTML code block wrappers...');
  ...
  try {
    ...
    console.log(`📝 Found ${blogsWithCodeBlocks.length} blogs with code block wrappers`);
