...
router.post("/:id/pdf", validateAndRecalculateProducts, async function (req, res) {
    try {
        ...
        const { generateJobOrderPDF } = await import("../../fileManagement/services/pdfService.js");
...
router.post("/:id/email", validateAndRecalculateProducts, async function (req, res) {
    try {
        ...
        const { getVendorById } = await import("../../vendors/services/vendorsService.js");
        ...
        const { generateJobOrderPDF } = await import("../../fileManagement/services/pdfService.js");
        const { sendJobOrderEmail } = await import("../../common/services/emailService.js");
        let pdfUrls;
        try {
