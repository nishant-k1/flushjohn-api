...
export const createOrUpdate = async (userId, leadId, data) => {
    try {
        const notification = await Notification.findOneAndUpdate({ userId, leadId }, {
            ...data,
            userId,
            leadId,
...
export const markAsRead = async (notificationId, userId) => {
    try {
        const notification = await Notification.findOneAndUpdate({ _id: notificationId, userId }, // Ensure user owns the notification
