...
router.post("/revenue/calculate", async (req, res) => {
    try {
        const { startDate, endDate, vendorTransactionCharges = 0, vendorTransactionChargesMode = "percentage", googleAdsSpending = 0, facebookAdsSpending = 0, instagramAdsSpending = 0, linkedInAdsSpending = 0, othersExpenses = 0, } = req.body;
