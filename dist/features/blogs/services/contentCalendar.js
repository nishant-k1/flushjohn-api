...
export const contentCalendar = {
    citySpecific: [
        ...
        {
            title: "Seattle Construction Site Porta Potty Requirements & Best Practices",
    ...
    industryGuides: [
        {
            title: "Construction Site Porta Potty Maintenance: OSHA Compliance & Best Practices",
            category: "construction",
            keywords: [
        ...
        {
            title: "Construction Site Porta Potty Placement: Safety and Compliance Guide",
            category: "construction",
            keywords: [
    ...
    seasonal: [
        {
            title: "Spring Wedding Season: Porta Potty Planning for Outdoor Ceremonies",
            category: "events",
            keywords: [
        ...
        {
            title: "Fall Construction Projects: Porta Potty Rental for Building Season",
            category: "construction",
            keywords: [
        ...
        {
            title: "Holiday Party Season: Porta Potty Rental for Corporate Celebrations",
            category: "events",
            keywords: [
...
export function getNextTopic(contentType = null, randomize = false) {
    ...
    if (contentType === "construction") {
        availableTopics = [
            ...contentCalendar.citySpecific.filter((topic) => topic.category === "construction" &&
                (topic.season === "year-round" || topic.season === season)),
            ...contentCalendar.industryGuides.filter((topic) => topic.category === "construction" &&
                (topic.season === "year-round" || topic.season === season)),
            ...contentCalendar.seasonal.filter((topic) => topic.category === "construction" &&
                (topic.season === season || topic.season === "year-round")),
        ];
    }
    else if (contentType === "city") {
        availableTopics = contentCalendar.citySpecific.filter((topic) => topic.season === "year-round" || topic.season === season);
    }
    else if (contentType === "problemSolving") {
        availableTopics = [
            ...contentCalendar.industryGuides.filter((topic) => topic.season === "year-round" || topic.season === season),
            ...contentCalendar.seasonal.filter((topic) => topic.season === season || topic.season === "year-round"),
        ];
    }
    else {
        ...
        switch (categoryRotation) {
            ...
            case 1: // Industry guides
                availableTopics = contentCalendar.industryGuides.filter((topic) => topic.season === "year-round" || topic.season === season);
                break;
            case 2: // Seasonal content
                availableTopics = contentCalendar.seasonal.filter((topic) => topic.season === season || topic.season === "year-round");
                break;
            case 3: // Case studies
                availableTopics = contentCalendar.caseStudies.filter((topic) => topic.season === "year-round" || topic.season === season);
                break;
            case 4: // Mixed content (random selection)
                ...
                ].filter((topic) => topic.season === "year-round" || topic.season === season);
                break;
        }
    }
    let topicIndex;
...
export function getTopicsForSeason(season) {
    return [
        ...contentCalendar.citySpecific.filter((topic) => topic.season === "year-round" || topic.season === season),
        ...contentCalendar.industryGuides.filter((topic) => topic.season === "year-round" || topic.season === season),
        ...contentCalendar.seasonal.filter((topic) => topic.season === season || topic.season === "year-round"),
        ...contentCalendar.caseStudies.filter((topic) => topic.season === "year-round" || topic.season === season),
    ];
}
