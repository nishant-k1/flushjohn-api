 ...
 */
export const findAll = async ({ query = {}, sort = {}, skip = 0, limit = 100, }) => {
...
export const updateById = async (id, updateData) => {
    return Payments.findByIdAndUpdate(id, { $set: updateData }, { new: true, runValidators: true });
};
export const findOneAndUpdate = async (query, updateData) => {
    return Payments.findOneAndUpdate(query, { $set: updateData }, { new: true, runValidators: true });
};
