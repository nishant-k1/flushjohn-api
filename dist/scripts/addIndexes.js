...
async function addIndexes() {
    try {
        ...
        await createIndexSafe(db.collection("quotes"), { createdAt: -1 }, "createdAt_-1");
        await createIndexSafe(db.collection("quotes"), { email: 1 }, "email_1");
        await createIndexSafe(db.collection("quotes"), { lead: 1 }, "lead_1");
        await createIndexSafe(db.collection("quotes"), { emailStatus: 1 }, "emailStatus_1");
        await createIndexSafe(db.collection("quotes"), { createdAt: -1, emailStatus: 1 }, "createdAt_-1_emailStatus_1");
        ...
        await createIndexSafe(db.collection("salesorders"), { createdAt: -1 }, "createdAt_-1");
        await createIndexSafe(db.collection("salesorders"), { email: 1 }, "email_1");
        await createIndexSafe(db.collection("salesorders"), { customer: 1 }, "customer_1");
        await createIndexSafe(db.collection("salesorders"), { lead: 1 }, "lead_1");
        await createIndexSafe(db.collection("salesorders"), { quote: 1 }, "quote_1");
        await createIndexSafe(db.collection("salesorders"), { emailStatus: 1 }, "emailStatus_1");
        await createIndexSafe(db.collection("salesorders"), { customerNo: 1 }, "customerNo_1");
        ...
        await createIndexSafe(db.collection("joborders"), { createdAt: -1 }, "createdAt_-1");
        await createIndexSafe(db.collection("joborders"), { email: 1 }, "email_1");
        await createIndexSafe(db.collection("joborders"), { salesOrder: 1 }, "salesOrder_1");
        await createIndexSafe(db.collection("joborders"), { lead: 1 }, "lead_1");
        await createIndexSafe(db.collection("joborders"), { customer: 1 }, "customer_1");
        await createIndexSafe(db.collection("joborders"), { emailStatus: 1 }, "emailStatus_1");
        await createIndexSafe(db.collection("joborders"), { vendorAcceptanceStatus: 1 }, "vendorAcceptanceStatus_1");
        await createIndexSafe(db.collection("joborders"), { jobOrderNo: 1 }, "jobOrderNo_1_index");
        console.log("✅ JobOrders indexes added\n");
        // Add indexes to Leads collection
        console.log("📊 Adding indexes to Leads collection...");
        await createIndexSafe(db.collection("leads"), { createdAt: -1 }, "createdAt_-1");
        ...
        await createIndexSafe(db.collection("leads"), { leadStatus: 1 }, "leadStatus_1");
        await createIndexSafe(db.collection("leads"), { leadSource: 1 }, "leadSource_1");
        await createIndexSafe(db.collection("leads"), { usageType: 1 }, "usageType_1");
        await createIndexSafe(db.collection("leads"), { zip: 1 }, "zip_1");
        await createIndexSafe(db.collection("leads"), { state: 1 }, "state_1");
        // Compound index for common queries
        await createIndexSafe(db.collection("leads"), { createdAt: -1, leadStatus: 1 }, "createdAt_-1_leadStatus_1");
        // Text index for search
        await createIndexSafe(db.collection("leads"), {
            fName: "text",
            lName: "text",
            email: "text",
            phone: "text",
        ...
        await createIndexSafe(db.collection("customers"), { createdAt: -1 }, "createdAt_-1");
        ...
        await createIndexSafe(db.collection("customers"), { customerNo: 1 }, "customerNo_1");
        ...
        await createIndexSafe(db.collection("vendors"), { createdAt: -1 }, "createdAt_-1");
        ...
        await createIndexSafe(db.collection("blogs"), { createdAt: -1 }, "createdAt_-1");
        await createIndexSafe(db.collection("blogs"), { slug: 1 }, "slug_1");
        await createIndexSafe(db.collection("blogs"), { status: 1 }, "status_1");
        await createIndexSafe(db.collection("blogs"), { createdAt: -1, status: 1 }, "createdAt_-1_status_1");
...
addIndexes();
//# sourceMappingURL=addIndexes.js.map