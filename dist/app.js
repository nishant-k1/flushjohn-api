...
if (!process.env.MONGO_DB_URI) {
    console.error("ERROR: MONGO_DB_URI environment variable is required for database connection");
    process.exit(1);
}
...
app.use("/blog-automation", authenticateToken, authorizeRoles("admin"), blogAutomationRouter); // Only admins can automate blogs
